<h1 align="center">Luciano Javier Delfino</h1>

<div align="center"><strong>IT Consultant  | Systems analyst | Software Developer | Entrepreneur</strong></div>
...
public function getPersonalInfo($name)
{
  ...
  if($name == "Luciano Delfino")
  {
    ...
    echo "Twitter: https://twitter.com/dlfluciano";
    echo "Facebook: https://www.facebook.com/luciano.dlf";
    echo "Google Developer Profile: https://g.dev/lucianodlf";
  }
...
```html
Freelance | 2021 - Actualidad 	| Santa Fe, Santa Fe, Argentina.
...
```html
DataLab Center  | http://datalabcenter.com | 08/2019 - 03/2020 | Quito, Pichincha, Ecuador.
...
+ Implementación de soluciones para mejorar la organización y gestión de proyectos y el ciclo de vida de desarrollo: Ej: implementación para la gestión de repositorios GIT con Gitea. 
+ Automatización de despliegues por entornos de testing/producción
...
```html
ANCA S.R.L | https://ancasrl.com.ar | 2016 - 2019 | Santa Fe, Santa Fe, Argentina.
...
### IT SUPPORT, SALES, AND ADMINISTRATION
```html
Raul Torres Hogar | 2006 - 2008 | Santa Fe, Santa Fe, Argentina.
...
<h3 align="center">ANTECEDENTES ACADÉMICOS</h3>
